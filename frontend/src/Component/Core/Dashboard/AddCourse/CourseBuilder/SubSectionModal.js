      ...
      const isFormUpdated = () => {
        ...
        const onSubmit = async (data) => {
            ...
            const updatedCourseContent = course.courseContent.map((section) =>
                ...
                ? { ...section, subSection: [...(section.subSection || []), result] }
                : section
            )
            const updatedCourse = { ...course, courseContent: updatedCourseContent }
            dispatch(setCourse(updatedCourse))
                ...
                <form onSubmit={handleSubmit(onSubmit )} className="space-y-8 px-8 py-10">
                  {/* Lecture Video Upload */}
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        className="w-full rounded-md !bg-richblack-700 !border !border-richblack-600 !text-richblack-5 !p-3 focus:!outline-none focus:!border-yellow-50"
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        className="resize-none min-h-[130px] w-full rounded-md !bg-richblack-700 !border !border-richblack-600 !text-richblack-5 !p-3 focus:!outline-none focus:!border-yellow-50"
                        {...register("lectureDesc", { required: true })}
                        />
                        {
                          errors.lectureDesc&&(<span className="ml-2 text-xs tracking-wide text-pink-200">  Lecture Description is required
                          </span>)
                        }
                    </div>
                    {!view && (
