...
import StatsComponent from '../Component/Core/About/Stats'
import LearningGrid from '../Component/Core/About/LearningGrid'
import ContactFormSection from '../Component/Core/ContactPage/ContactFormSection'
                ...
                <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                    ...
                    and nurturing a vibrant learning community.
                      ...
                      <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
                         ...
                         <img src={BannerImage1} alt="About Us" />
                         <img src={BannerImage2} alt="About Us" />
                         <img src={BannerImage3} alt="About Us" />
                      </div>
                </div>
            </section>
            ...
            <section>
                 <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
                        {/* TOP BOX */}
                         ...
                         {/* Vision and mission Wala parent */}
